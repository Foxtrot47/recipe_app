...
const Navbar = () => {
  ...
  window.addEventListener("click", (e) => {
    ...
    if (document.getElementById("mobile-search-button").contains(e.target)) {
      ...
      Array.from(document.getElementsByClassName("body")).forEach((el) => {
  ...
  return (
    <nav className="bg-white text-gray-900 border-gray-200 px-5 md:px-10 pb-2 pt-3 dark:bg-gray-900 fixed top-0 w-full drop-shadow z-10 font-medium dark:text-white">
