...
const RecipeCardSmallHorizontal = ({ recipeData, dataLoading, error }) => {
  return (
    <Link
      href={(!dataLoading ? recipeData.url : "")}
      className="flex flex-row hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg hover:drop-shadow-lg group"
    >
...
export default RecipeCardSmallHorizontal;
