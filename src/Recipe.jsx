...
const Recipe = () => {
  ...
  const recipeCategories = ['Breakfast','Lunch','Dinner','Drink','Pasta','Pizza','Salad'];
            ...
            <div className="flex flex-col gap-y-1 ">
              <div className="flex flex-row gap-x-4 p-2 mb-1 ">
                ...
                <div className=" flex flex-row gap-x-1">
                  ...
                  <span>Cuisine:</span>
                  <span className="text-gray-500 italic">{ !loading && data.cuisines.map(cuisine => cuisine + ", ") }</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-x-1">
                <div className="flex flex-row gap-x-4 px-4 py-5 justify-center items-center rounded bg-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-500">{ !loading && data.readyInMinutes }m</span>
                  </div>
                </div>
                <div className="flex flex-row gap-x-4 px-2 justify-center items-center rounded bg-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-500">{ !loading && data.healthScore }</span>
                  </div>
                </div>
                <div className="flex flex-row gap-x-4 px-8 justify-center items-center rounded bg-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-500">{ !loading && data.servings }</span>
                  </div>
                </div>
                <div className="flex flex-row gap-x-4 px-8 justify-center items-center rounded bg-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-500">{ !loading && data.aggregateLikes }</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-6 mt-4 w-full">
                <div className="bg-gray-100 flex flex-col gap-y-4 py-4 px-6">
                  ...
                  <div className="bg-white drop-shadow-lg p-4">
                    <ul className="pl-4 mt-2 text-lg flex flex-col gap-y-4">
                      { !loading && data.extendedIngredients.map((ingredient,id)=>{
                ...
                <div className="bg-red-50 flex flex-col gap-y-4 py-4 px-6">
                  ...
                  <span>Per Serving: { !loading && data.nutrition.weightPerServing.amount + data.nutrition.weightPerServing.unit }</span>
                  <div className="bg-white drop-shadow-lg p-4 flex flex-col gap-y-2 pt-6 text-lg">
                    ...
                    <div className="w-full flex flex-col gap-y-4">
                      {
                        !loading && data.nutrition.nutrients.map((nutrient,id)=>{
                          ...
                          if ( nutrient.name === "Calories" ||
                              ...
                              return (
                                <div key={id} className="flex flex-row justify-between">
                                  <span className="text-gray-600">{ nutrient.name }:  { nutrient.amount + nutrient.unit } </span>
                                  <span className="font-semibold">{ nutrient.percentOfDailyNeeds }%</span>
                                </div>
                              )
                             }
                        })
              ...
              </div>
              {
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col gap-y-9 my-10">
                    {
                      data.analyzedInstructions[0].steps.map((instruction,id)=>{
                        return (
